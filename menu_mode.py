...
def create_new_world():
    ...
    # fill here
    # {name= "Nayeon", x=  3800, y=  2560, size = 1.0},
    #
    # zombie = Zombie('Nayeon', 3800, 2560, 1.0)
    # game_world.add_object(Zombie('Zwi', 3700, 2560, 1.5), 1)
    # game_world.add_object(Zombie('yuri', 3600, 2560, 1.0), 1)
